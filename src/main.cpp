...
unsigned int nStakeMaxAge = 7 * 60 * 60;
...
const string strMessageMagic = "MultiMillionaire Signed Message:\n";
...
const int DAILY_BLOCKCOUNT =  1728;
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MultiMillionaire", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
		...
		uint256 nhashMerkleRoot = uint256("0xd0dcdbf856c7c53e903fb11012f9303045c2c1af64c0a47851a15b518931232a");
