...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("MultiMillionaire-ext-ip");
...
void ThreadSocketHandler(void* parg)
{
    ...
    RenameThread("MultiMillionaire-net");
...
void ThreadMapPort(void* parg)
{
    ...
    RenameThread("MultiMillionaire-UPnP");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "MultiMillionaire " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("MultiMillionaire-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("MultiMillionaire-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("MultiMillionaire-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("MultiMillionaire-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. MultiMillionaire is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("MultiMillionaire-start");
